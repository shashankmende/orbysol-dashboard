        ...
        <div className='container2'>
          ...
          <div className='three-containers'>
            ...
            <div>
              ...
              {showProfile && <div className='overlay-container'>
                <div className='pop-up-container'>
                  <div className='pop-up-content-container'>
                    ...
                    <div className='pop-up-text-container'>
                      ...
                      <p className='links-para' ><a className='link' href='/login'>My Profile</a></p>

                      <p className='links-para'><a className='link' href='/login'>Change Password</a></p>

                      <p className='links-para'><a className='link' href='/settings'>Settings</a></p>

                      <p className='links-para'><a href='/help' className='link'>Help</a></p>
