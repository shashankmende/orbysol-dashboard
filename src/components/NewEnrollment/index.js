...
//  first set
    ...
    <div className="new-enrollment-container">
        ...
        <div className="order-provider-container">
            <label htmlFor="order-provider" className="names-label order-label">Order Provider<sup>*</sup></label>
        ...
        <div className="order-provider-container">
            <label htmlFor="Reading-provider" className="names-label  order-label">Reading Provider<sup>*</sup></label>
        ...
        <div className="order-provider-container">
            <label htmlFor="Referring-provider" className="names-label  order-label">Referring Provider</label>
